<nav>
   ...
   <li className="item-nav">
            ...
            <li class="item-nav">
              ...
              <li class="item-nav">
                <a class="nav-link @if (Request::route()->getName()== 'about') active @endif" aria-current="page" href="{{route('about')}}">À PROPOS DE NOUS </a>
              </li>

                <li class="item-nav">
                  <a class="nav-link @if (Request::route()->getName()== 'realisation') active @endif" aria-current="page" href="{{route('realisation')}}">NOS REALISATION</a>
                </li>
                <li class="item-nav">
                ...
                <li class="item-nav">
                  <a class="nav-link @if (Request::route()->getName()== 'contact') active @endif"  href="{{route('contact')}}">NOUS CONTACTER</a>
                </li>
